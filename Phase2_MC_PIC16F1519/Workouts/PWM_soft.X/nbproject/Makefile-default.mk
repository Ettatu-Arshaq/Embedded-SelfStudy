...
FINAL_IMAGE=${DISTDIR}/PWM_soft.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PWM_soft.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
